...
namespace spr421_spotify_clone.BLL.Services.Auth
{
    public class AuthService : IAuthService
    {
        ...
        {
            return await _userManager.Users.FirstOrDefaultAsync(u => u.NormalizedEmail == login.ToUpper() || u.NormalizedUserName == login.ToUpper());
        ...
        private async Task<string> GenerateJwtTokenAsync (ApplicationUser user)
        {
            ...
            var roleClaims = userRoles.Select(x => new Claim("role", x));
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddHours(_jwtSettings.ExpiresHours),
